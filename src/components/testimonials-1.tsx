...
export default function TestimonialsOne() {
    return (
        <section id="customers" className="py-16 md:py-32">
                ...
                <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-4 lg:grid-rows-2">
                    ...
                    <Card className="md:col-span-2">
                        <CardContent className="h-full pt-5">
                            <blockquote className="grid h-full grid-rows-[1fr_auto] gap-2">
                                <p className="text-sm font-medium">Tailus is really extraordinary and very practical, no need to break your head. A real gold mine.</p>
